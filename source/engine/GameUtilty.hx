...
class GameUtilty {
     ...
     */
    public static function playMusic(manager:Song, title:String, ?instOnly:Bool = false, ?dualVocals:Bool = true):Map<String, FlxSound> {
        manager.clear();

        var _tracks:Map<String, FlxSound> = new Map();
