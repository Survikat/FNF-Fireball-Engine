...
## Notice
Fireball Engine is not affiliated with The Funkin' Crew Inc, and it requires the base game to run. No assets or source code from the original project is used here.
...
### Pull Requests
Do not submit AI Generated code or assets in a PR, all code must be human written and tested before submitting.