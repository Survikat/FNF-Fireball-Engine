...
## Notice
Fireball Engine is not affiliated with "The Funkin' Crew Inc." or "Friday Night Funkin'", and it requires the base game to run properly. No assets or source code or assets from Friday Night Funkin' is used here. Zero code or assets were made with Generative AI.
